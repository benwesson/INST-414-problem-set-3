...
def main():
    ...
    #print(genre_list, genre_true_counts, genre_tp_counts, genre_fp_counts)
    ...
    calculate_metrics(model_pred_df, genre_list, genre_true_counts, genre_tp_counts, genre_fp_counts)
    # Print micro metrics
